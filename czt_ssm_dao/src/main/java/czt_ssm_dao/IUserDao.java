...
public interface IUserDao {
    ...
    @Results({
        ...
        @Result(property = "roles", column = "id",javaType = java.util.List.class,many =@Many(select = "czt_ssm_dao.IRoleDao.findRole")),
    ...
    void addRoletuUser(@Param("uid") String uid,@Param("rid") String rid);
}
